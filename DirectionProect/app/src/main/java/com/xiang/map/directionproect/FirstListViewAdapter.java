 ...
 */
public class FirstListViewAdapter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        listRecyViewAdapter = new ListRecyViewAdapter(FirstListViewAdapter.this, persens);
        //横向
       ...
       // recyView.setLayoutManager(new LinearLayoutManager(this));
        ...
        listRecyViewAdapter.setListViewClick(new ListRecyViewAdapter.ListViewClick() {
            ...
            public void listItemClick(View view, int position) {
                Toast.makeText(FirstListViewAdapter.this,"点击了"+position,Toast.LENGTH_LONG).show();
            }

            @Override
            public void listItemLongClick(View view, int position) {
                Toast.makeText(FirstListViewAdapter.this,"长按了"+position,Toast.LENGTH_LONG).show();
            }
        });
